    ...
    (
      ...
      >
        ...
        >
          ...
          <span style={{ fontSize: "72px", fontWeight: "bold", color: "#fafafa" }}>
            Pay<span style={{ color: "#ea580c" }}>Copy</span>
          </span>
        </div>
        <p style={{ fontSize: "36px", color: "#ea580c", margin: "0", fontWeight: "bold" }}>
          Te enviaron un cobro
        </p>
        <p style={{ fontSize: "22px", color: "#a1a1a1", marginTop: "16px" }}>
